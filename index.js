...
'redis://:pa8f1306ae9ab8fe1e72e11104b0579279f1dc0f810f0ea0bd82ffb46b9f87698@ec2-23-23-57-177.compute-1.amazonaws.com:20989';
...
app.post('/api/mine', (req,res) => {
    ...
    console.log("Hola");
    const lastBlock = DatabaseModel.obtainLastBlock();
    console.log(await lastBlock);
    let newBlock = blockchain.addBlock(await lastBlock, data);
    console.log("Adios");
    DatabaseModel
        .insert(newBlock)
        .then(()=>{
